...
public class Puzzle24Board {
    public static final int SIZE = 5; // Define SIZE as a public static constant
    private final int[][] board;
    private static final int[][] DIRECTIONS = {{-1, 0}, {1, 0}, {0, -1}, {0, 1}};


    // Constructor to initialize the board
    public Puzzle24Board() {
        board = new int[SIZE][SIZE];
    }

    // Constructor to create a deep copy of another Puzzle15Board object
    public Puzzle24Board(Puzzle24Board other) {
    ...
    public void printBoard() {
        System.out.println("Current Puzzle 24 board:");
        for (int i = 0; i < SIZE; i++) {
            for (int j = 0; j < SIZE; j++) {
    ...
    public List<Puzzle24Board> generateNeighbors() {
        List<Puzzle24Board> neighbors = new ArrayList<>();
        int[] emptyPosition = findEmptyPosition();
        int emptyRow = emptyPosition[0];
        int emptyCol = emptyPosition[1];
        ...
        for (int[] direction : DIRECTIONS) {
            ...
            if (isValidPosition(newRow, newCol)) {
                Puzzle24Board neighborBoard = new Puzzle24Board(this);
